...
// getting user from database
 public function read_single_user_id() {
    //create query
    $userQuery ='SELECT id, password, email, fname,lname, phoneNumber, country, county, sub_county, city, postal_address,role, photoUrl FROM users WHERE id= :id';
